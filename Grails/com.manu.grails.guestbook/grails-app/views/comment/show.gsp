            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.feedback.label" default="Feedback" /></td>
                            
                            <td valign="top" class="value"><g:link controller="feedback" action="show" id="${commentInstance?.feedback?.id}">${commentInstance?.feedback?.encodeAsHTML()}</g:link></td>
