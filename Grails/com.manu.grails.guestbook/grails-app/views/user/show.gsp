...
<%@ page import="com.manu.grails.guestbook.User" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.webpage.label" default="Webpage" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "webpage")}</td>
