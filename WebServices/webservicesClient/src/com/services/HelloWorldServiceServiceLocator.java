...
public class HelloWorldServiceServiceLocator extends org.apache.axis.client.Service implements com.services.HelloWorldServiceService {
    ...
    private java.lang.String HelloWorldService_address = "http://localhost:8080/webservices/services/HelloWorldService";
    ...
    public com.services.HelloWorldService getHelloWorldService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.HelloWorldServiceSoapBindingStub _stub = new com.services.HelloWorldServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.HelloWorldService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.HelloWorldServiceSoapBindingStub _stub = new com.services.HelloWorldServiceSoapBindingStub(new java.net.URL(HelloWorldService_address), this);
                _stub.setPortName(getHelloWorldServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.com", "HelloWorldServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.com", "HelloWorldService"));
        }
