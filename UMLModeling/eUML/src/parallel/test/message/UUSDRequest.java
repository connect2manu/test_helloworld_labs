...
public class UUSDRequest extends Request {
	
	final REQUEST_TYPE reuquestType = REQUEST_TYPE.UUSD_EJB;
	
	private String requestId;

	public UUSDRequest(String requestId) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UUSDRequest other = (UUSDRequest) obj;
		if (requestId == null) {
