...
/**
 * Business DAO operations related to the <tt>CategorizedItem</tt> entity.
 * <p>
 ...
 *
 * @see org.hibernate.ce.auction.model.CategorizedItem
 *
 * @author christian.bauer@jboss.com
 */
public interface CategorizedItemDAO
        extends GenericDAO<CategorizedItem, CategorizedItem.Id> {
    // Empty
}
